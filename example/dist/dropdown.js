...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Dropdown = __webpack_require__(551);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dropdown = function (_Widget) {
	  ...
	  function Dropdown(props) {
	    ...
	    _this.instanceId = Dropdown.instanceId++;
	    return _this;
	  }
	  /**
	   * 根据value值调整option
	  ...
	  _createClass(Dropdown, [{
	    ...
	    value: function adaptOptions() {
	      ...
	      var options = props.options.map(function (itemData) {
	      ...
	      if (props.autoSelectFirstOption) {
	        if (options.length) {
	          if (!options.some(function (itemData) {
	    ...
	    key: 'syncStateFromProps',
	    value: function syncStateFromProps(props) {
	      var selectedOption = props.options.find(function (itemData) {
	        return itemData.selected;
	      });
	      if (selectedOption) {
	        this.setState({
	    ...
	    value: function componentDidMount() {
	      ...
	      this.nextTick(function () {
	        _this2.syncStateFromProps(_this2.props);
	      });
	      $('body').on('mousedown.Dropdown' + this.instanceId, function (evt) {
	        if (Dropdown.activeInstanceId === _this2.instanceId) {
	          if (!Dropdown.isInContainer(evt.target, [_reactDom2['default'].findDOMNode(_this2), panelContainer])) {
	            _this2.setState({
	              panelStyle: {
	                display: 'none'
	              }
	    ...
	    value: function componentWillUnmount() {
	      if (Dropdown.activeInstanceId === this.instanceId) {
	        _reactDom2['default'].unmountComponentAtNode(panelContainer);
	        Dropdown.activeInstanceId = -1;
	      }
	    ...
	    value: function handleInputClick() {
	      ...
	      if (!props.disabled) {
	        ...
	        Dropdown.renderPanel(this, function () {
	          _this3.setState({
	            panelStyle: Dropdown.getPanelStyle(_reactDom2['default'].findDOMNode(_this3), panelContainer.firstChild)
	          });
	        });
	        // this.setState({
	        //   display: 'none'
	    ...
	    value: function handleInputKeydown(evt) {
	      ...
	      if (expr) {
	        currentSelectedIndex = props.options.findIndex(function (itemData) {
	          return itemData.selected;
	        });
	        ...
	        //反射
	        props.onOptionsChange.call(this, [].concat(props.options).map(function (itemData, i) {
	          itemData.selected = i === currentSelectedIndex ? true : false;
	          return itemData;
	        }));
	      }
	    }
	    ...
	    value: function handleOptionClick(option) {
	      ...
	      if (!option.disabled) {
	        // 如果该option未被禁用
	        var oldSelectedValue = props.options.find(function (itemData) {
	          return itemData.selected;
	        });
	    ...
	    value: function render() {
	      ...
	      if (Dropdown.activeInstanceId === this.instanceId) {
	        setTimeout(function () {
	          Dropdown.renderPanel(_this4);
	        }, 0);
	      }
	      var cls = props.disabled ? prefixCls + '-disabled' : '';
	      var stateCls = Dropdown.activeInstanceId === this.instanceId && state.panelStyle.display === 'block' ? prefixCls + '-state-active' : '';
	      return _react2['default'].createElement(
	        'span',
	        { className: prefixCls + ' ' + prefixCls + '-' + this.instanceId + ' ' + props.className + ' ' + cls + ' ' + stateCls },
	        _react2['default'].createElement('input', { type: 'text', className: prefixCls + '-input-text', value: state.text, title: state.text, onKeyDown: this.handleInputKeydown.bind(this), onClick: this.handleInputClick.bind(this), readOnly: true, placeholder: props.placeholder }),
	        _react2['default'].createElement('span', { className: prefixCls + '-input-icon' })
	      );
	    }
	  }]);
	...
	Dropdown.renderPanel = function (cpt, callback) {
	  ...
	  _reactDom2['default'].render(_react2['default'].createElement(
	    ...
	    callback && callback();
	    Dropdown.scrollToSelectedItem(props.options.findIndex(function (itemData) {
	      return itemData.selected;
	    }));
	  });
	};
	...
	Dropdown.getPanelStyle = function (baseSelector, panelSelector) {
	  ...
	  //先垂直设置
	  if (baseOffset.top - winScrollTop > winHeight - (baseOffset.top - winScrollTop + baseHeight)) {
	    //如果上方的高度大于下方
	    //设置面板最大高度
	...
	Dropdown.isInContainer = function (elemSelector, container) {
	  ...
	  return [].concat(container).some(function (cSelector) {
	    var cEl = $(cSelector);
	...
	Dropdown.propTypes = {
	  ...
	  autoSelectFirstOption: _react2['default'].PropTypes.bool,
	  options: _react2['default'].PropTypes.array,
	  onChange: _react2['default'].PropTypes.func,
	  onOptionsChange: _react2['default'].PropTypes.func,
	  getDefaultPanelTemplate: _react2['default'].PropTypes.func
	};
	Dropdown.defaultProps = {
	  ...
	  getDefaultPanelTemplate: function getDefaultPanelTemplate() {
	    var _this5 = this;
	    ...
	    return _react2['default'].createElement(
	      'ul',
	      { className: props.prefixCls + '-options-list' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/**\n * form样式\n */\n \n\n/**\n * DateInput\n */\n \n\n/**\n * ColorInput\n */\n \n\n/**\n * Dropdown\n */\n \n\n.ui-form-dropdown-datapane {\n  overflow: auto;\n}\n \n\n.ui-form-dateinput-calendar-panel {\n  position: relative;\n}\n \n\n.ui-form-dateinput-clear-btn {\n  position: absolute;\n  bottom: 8px;\n  left: 8px;\n}\n", "", {"version":3,"sources":["/../../src/component/form/form.css"],"names":[],"mappings":"AAAA;;GAEG;;;AAGH;;GAEG;;;AAEH;;GAEG;;;AAEH;;GAEG;;;AACH;EACE,eAAe;CAChB;;;AACD;EACE,mBAAmB;CACpB;;;AACD;EACE,mBAAmB;EACnB,YAAY;EACZ,UAAU;CACX","file":"form.css","sourcesContent":["/**\n * form样式\n */\n \n\n/**\n * DateInput\n */\n\n/**\n * ColorInput\n */\n\n/**\n * Dropdown\n */\n.ui-form-dropdown-datapane {\n  overflow: auto;\n}\n.ui-form-dateinput-calendar-panel {\n  position: relative;\n}\n.ui-form-dateinput-clear-btn {\n  position: absolute;\n  bottom: 8px;\n  left: 8px;\n}\n"],"sourceRoot":"webpack://"}]);
