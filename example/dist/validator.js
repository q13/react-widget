...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function handleTestChange(evt) {
	      this.setState({
	        formFields: _index2['default'].getNewFields(evt.target.value, 'test', this.state.formFields)
	      });
	    }
	  }, {
	    key: 'handleTest2Change',
	    ...
	    key: 'handleValidate',
	    value: function handleValidate(result) {
	      console.log('validateResult1111', result);
	    }
	  }, {
	    key: 'handleFieldsChange',
	    value: function handleFieldsChange(fields) {
	      this.setState({
	        formFields: fields
	      });
	    }
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        _index2['default'],
	        { ref: 'v', fields: formFields, onValidate: this.handleValidate.bind(this), onFieldsChange: this.handleFieldsChange.bind(this) },
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'div',
	            null,
	            _react2['default'].createElement('input', { type: 'text', value: formFields.test.value, onChange: this.handleTestChange.bind(this) }),
	            _react2['default'].createElement(
	              'span',
	              { className: 'error' },
	              formFields.test.isValid === false ? formFields.test.message : ''
	            )
	          ),
	          _react2['default'].createElement(
	            'div',
	            null,
	            _react2['default'].createElement('input', { type: 'text', value: formFields.test2.value, onChange: this.handleTest2Change.bind(this) }),
	            _react2['default'].createElement(
	              'span',
	              { className: 'error' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Validator = function (_Widget) {
	  _inherits(Validator, _Widget);
	  ...
	  _createClass(Validator, [{
	    ...
	    key: 'getValidValue',
	    value: function getValidValue(excludeEmpty) {
	      var props = this.props;
	    ...
	    value: function validate(fieldName) {
	      ...
	      diffValueOfFields.forEach(function (v) {
	        var targetFieldName = void 0;
	        if (fieldKeys.some(function (k) {
	          if ([].concat(fields[k].bindField).some(function (j) {
	            if (j === v) {
	              targetFieldName = k;
	              return true;
	            }
	      ...
	      function validateField(fieldName) {
	        var bindField = [].concat(fields[fieldName].bindField || []);
	        bindField = bindField.map(function (fieldName) {
	          return fields[fieldName].value + '';
	        });
	        var stateField = state.fields[fieldName] || {};
	        var fieldValidateResult = Validator.validate(fields[fieldName], bindField);
	      ...
	      if (validateErrorResult.length) {
	        ...
	        diffValueOfFields.forEach(function (k) {
	          var fieldValidateResult = validateErrorResult.find(function (itemData) {
	      ...
	      //构建整体验证结果
	      returnData = Object.keys(stateFields).reduce(function (pv, cv) {
	    ...
	    key: 'validate',
	    value: function validate(field, bindFieldValue) {
	      ...
	      if (typeof allowBlank === 'function') {
	        //用作及时判定
	        allowBlank = allowBlank.apply(undefined, [value].concat(_toConsumableArray(bindFieldValue)));
	      }
	      if (allowBlank === true) {
	      ...
	      if (ignore) {
	        if (ignore === true) {
	          ...
	          if (ignore.apply(undefined, [value].concat(_toConsumableArray(bindFieldValue)))) {
	            rule = [true, function () {
	              return 'abort';
	            }].concat(rule);
	            indexOffset = 2;
	      ...
	      return rule.reduce(function (pv, cv, ci, arr) {
	        var validateResult;
	        if (pv.isAbort) {
	          return pv;
	        }
	        if (typeof cv === 'boolean') {
	          ...
	          var _Validator$defaultRul;
	
	          var params = [value].concat(bindFieldValue);
	          validateResult = (_Validator$defaultRul = Validator.defaultRule)[cv].apply(_Validator$defaultRul, _toConsumableArray(params));
	        } else if (cv instanceof RegExp) {
	          validateResult = cv.test(value);
	        } else if (typeof cv === 'function') {
	          validateResult = cv.apply(undefined, [value].concat(_toConsumableArray(bindFieldValue)));
	        } else {
	          var _Validator$defaultRul2;
	
	          //object
	          validateResult = (_Validator$defaultRul2 = Validator.defaultRule)[cv['name']].apply(_Validator$defaultRul2, [value, cv['params']].concat(_toConsumableArray(bindFieldValue)));
	        }
	        //判断结果
	...
	Validator.propTypes = {
	  ...
	  onRulesChange: _react2['default'].PropTypes.func
	};
	...
	Validator.defaultRule = {
	   ...
	   * @return {[type]}      [description]
	   */
	  length: function length(v, params) {
	    params = Object.assign({
	      hanCharLength: 1,
	      min: 1,
	      max: Number.POSITIVE_INFINITY
	    }, params || {});
	    var num = v.replace(/[^\x00-\xff]/g, "0123456789".slice(0, params.hanCharLength)).length;
	    if (num < params.min) {
	      return false;
	    }
	    if (num > params.max) {
