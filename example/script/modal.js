...
class Page extends React.Component {
  jsxModals() {
    ...
    var jsxModal1 = (<Modal ref="jsxModal1">
        这是在弹框1内显示的内容-开始
        <br/><button onClick={() => { this.refs.jsxModal2.handleOpenModal(); }}>显示第2个弹框</button>
        <hr/>点击右上x按钮关闭本弹框<hr/>
        <br/>这是在弹框1内显示的内容-结束
      </Modal>);
    //JSX描述第二个弹框：参数调用
    var jsxModal2 = (<Modal ref="jsxModal2"
       ...
       >
        ...
        <button onClick={() => { this.refs.jsxModal2.handleCloseModal(); }}>关闭本弹框</button>
    ...
    var jsxPage = (<div style={{background:'white'}}>
      <table>
        <tbody>
          ...
          <tr>
            <td colSpan="20">
              <button onClick={() => { this.refs.jsxModal1.handleOpenModal(); }}>显示第1个弹框</button>
              <button onClick={() => { ReactDOM.render(<div />, pageContainer); }}>销毁页面内容</button>
            </td>
          </tr>
        </tbody>
